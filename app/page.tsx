    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: 22, color: "#cbd5e1", maxWidth: 650 }}>
          Serving Danbury, CT and surrounding areas including Bethel,
          Brookfield, Newtown, and Ridgefield.
        </p>

        <p style={{ fontSize: 20, color: "#94a3b8", maxWidth: 650 }}>
          Fast water extraction, drying, dehumidification, and mold prevention
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          >
            {[
              [
                "Water Extraction",
                "Remove standing water fast from floors, basements, carpets, and affected areas.",
              ],
              [
                "Drying & Dehumidification",
                "Professional drying setup to reduce moisture and protect the structure.",
              ],
              [
                "Mold Prevention",
                "Moisture control to help reduce the chance of mold growth after water damage.",
              ],
            ].map(([title, text]) => (
              <div
                key={title}
      ...
      <section style={{ padding: "60px 24px", textAlign: "center" }}>
        <h2 style={{ fontSize: 44 }}>
          Need Water Cleanup Now?
        </h2>

        <p style={{ fontSize: 22, color: "#cbd5e1" }}>
          Call E.D.W.A.R.D. Water Restoration today.
        </p>
