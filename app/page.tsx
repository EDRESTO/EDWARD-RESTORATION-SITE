    ...
    No pressure. Send your information and we’ll call you momentarily.
      ...
      <footer style={{ background: "#050b14", borderTop: "1px solid rgba(34,211,238,0.24)", padding: "38px 20px 92px", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: 18, flexWrap: "wrap", marginTop: 18 }}>
          <a className="legalLink" href="/privacy-policy" style={{ fontSize: 13 }}>Privacy Policy</a>
          <a className="legalLink" href="/terms-and-conditions" style={{ fontSize: 13 }}>Terms & Conditions</a>
        </div>
      </footer>
