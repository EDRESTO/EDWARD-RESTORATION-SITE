  ...
  return (
    <main style={{ fontFamily: "Arial, sans-serif", background: "#07111f", color: "white", minHeight: "100vh" }}>
      ...
      <section style={{ display: "flex", justifyContent: "center", background: "#07111f" }}>
        <div style={{ width: "100%", maxWidth: "900px", height: "6px", background: "#d9ff3f", borderRadius: "4px", margin: "5px 0 10px" }} />
      </section>
      ...
      <section style={{ padding: "10px 24px 60px", maxWidth: 1100, margin: "-20px auto 0" }}>
        ...
        <a
          ...
          style={{ display: "inline-block", marginTop: 30, background: "#d9ff3f", color: "#07111f", padding: "18px 28px", borderRadius: 14, fontWeight: 900, textDecoration: "none", fontSize: 22 }}
        >
          CALL 1 (855) WTFLOOD
        </a>
      ...
      <section style={{ padding: "60px 24px", textAlign: "center" }}>
        ...
        <a
          href="tel:18559835663"
          style={{ display: "inline-block", marginTop: 24, background: "#22d3ee", color: "#07111f", padding: "18px 28px", borderRadius: 14, fontWeight: 900, textDecoration: "none", fontSize: 22 }}
        >
          TAP TO CALL
        </a>
      </section>
